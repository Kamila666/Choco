...
public class ShareCode extends BeforeAfterTest {
    ...
    public void profile() {
        ...
        boolean flag = (description.getText()).equals("Отправь друзьям свой личный код. Они получат 500 на баланс РАХМЕТА, а ты 500 за каждого, кто совершит свою первую покупку РАХМЕТом (не меньше, чем на 700 тг)");
